...
const navLinks = [
  ...
  { num: "04", href: "#methode", label: "Méthode" },
];
...
const pillars: {
  ...
  },
  {
    ...
    desc: "Maîtrise du règlement DORA, du RGPD, de l'AI Act et des cadres internes de gouvernance des données. Les exigences réglementaires européennes sont intégrées dès la conception, pas en bout de chaîne.",
    keys: "DORA · RGPD · AI Act · ISO 27001",
  },
  {
    glyph: "γ",
    title: "Expertise technique",
    desc: "Architecture data et IA, applications agentiques, bases de connaissance et ontologies — une couverture technique complète, de la modélisation des données à l'orchestration des agents.",
    keys: "Architecture Data & IA · Applications agentiques · Bases de connaissance · Ontologies",
  },
  {
    glyph: "δ",
    title: "Industrialisation",
    desc: "Nos solutions sont conçues dès l'origine pour être industrialisées : reproductibilité, passage à l'échelle et maintien en conditions opérationnelles font partie du cadrage initial, pas d'une phase ultérieure.",
  },
];
...
const phases = [
  ...
  },
  {
    ...
    title: "Recherche",
    week: "Semaines 3–4",
    desc: "Benchmark des solutions IA on-premise, hybrides et open source. Analyse des tendances sectorielles, étude DORA et AI Act.",
    deliv: "→ Benchmark IA",
  },
  {
    num: "03",
    title: "Analyse",
    week: "Semaines 5–6",
    desc: "SWOT contextualisé, audit on-premise vs cloud vs hybride, matrice d'alignement stratégique, recommandations priorisées.",
  ...
  },
  {
    ...
    title: "Restitution",
    week: "Semaines 7–8",
    desc: "Présentation des résultats et remise d'une documentation directement réutilisable en interne.",
    ...
    <>
      ...
      <section className="hero" id="top">
        <div className="wrap">
          <Reveal className="eyebrow" style={{ marginBottom: 56 }}>
            Kotech Engineering · Conseil et réalisation en intelligence artificielle
          </Reveal>
        ...
        <div className="wrap">
          <div className="stats-row">
            <div className="stat-item">
              <div className="stat-since">Depuis 2021 —</div>
            </div>
            <div className="stat-item">
            ...
            <div className="stat-item">
              ...
              <div className="stat-l">Présence</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="section-head">
            ...
            <Reveal className="quote">
              Notre conviction&nbsp;: l&apos;IA est un catalyseur — elle amplifie la créativité,
              renforce la décision, et fait progresser l&apos;organisation, à condition de rester
              ancrée dans son contexte humain et technique.
            </Reveal>
          </div>
          <div className="manifeste-grid">
            {[
              ...
              },
              {
                ...
                text: "Nous accompagnons le passage de l'expérimentation au produit IA reproductible. C'est là que la valeur se crée — et qu'elle se mesure.",
              },
            ].map((item) => (
            ...
            {pillars.map((pillar) => (
              <Reveal key={pillar.glyph} className="pillar">
                ...
                <div>
                  <h3>{pillar.title}</h3>
                  <p>{pillar.desc}</p>
                  {pillar.keys ? <div className="keys">{pillar.keys}</div> : null}
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <section className="block" id="methode">
        <div className="wrap">
          <div className="section-head">
            <div className="left">
              <span className="num">04 — Méthode</span>
              <div className="eyebrow">Audit & benchmark IA</div>
            </div>
            <p className="section-lede">
              Notre méthodologie d&apos;<em>audit et benchmark</em> des solutions IA, adaptée au
              contexte de chaque client — une démarche structurée et factuelle, du cadrage à la
              restitution, pour produire des livrables réutilisables en interne.
            </p>
          </div>
      ...
      <section className="block" id="apropos">
        <div className="wrap">
          <div className="section-head">
            <div className="left">
              <span className="num">05 — À propos</span>
          ...
          <div className="about-grid">
            <div className="about-text">
              ...
              <Reveal>
                <p>
                  Derrière Kotech, <em>toute une équipe</em> de passionnés de technologie : experts
                  Data et Cloud, agents IA, bases de connaissance, gestion de projet IA et
              ...
              <Reveal>
                <p>
                  ...
                  on-premise, open source et réglementés — de la feuille de route à la mise en
                  production.
                </p>
              </Reveal>
            </div>
            <Reveal className="founder-card">
              ...
              <p style={{ marginTop: 18 }}>
                Il s&apos;appuie sur une équipe de passionnés de technologie pour couvrir
                l&apos;ensemble du cycle de vie d&apos;une initiative IA.
              </p>
            </Reveal>
          </div>
        </div>
          ...
          <div className="contact-grid">
            <div className="contact-actions">
              ...
              <div className="row">
                ...
                <a href="tel:+33637864348" className="v">
                  +33 (0) 6 37 86 43 48
                </a>
              </div>
              <div className="row">
      ...
      <footer className="foot">
        <div className="wrap inner">
          ...
          <div className="links">
            <Link
              href="https://www.linkedin.com/company/kotechengeneering/about/"
              target="_blank"
